...
try
{
	...
	while(rs.next())
	{
		...
		{ %>
			<h2 style="text-align:center;font-size:50px;"><i>No students have been selected yet.</i></h2>
<%			return;
		}
		
	} %>
	
	<h1 style="text-align:center;color:red;"><u><i>Selected Students</i></u></h1>
	<table width="100%" border="10">
	
<%	sql = "select est_recruit,recruited from "+compName+" where id=?";
	ps = cn.prepareStatement(sql);
	ps.setString(1, compID);
	rs = ps.executeQuery();
	String recruited="";
	while(rs.next())
	{
		recruited = rs.getString(2)+" / "+rs.getString(1);
	} %>
	
	<h1 style="text-align:;color:red;"><b>Recruited: <%=recruited %></b>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;
	<input type="button" value="Recuit Students" onclick="recruit(this)">
	</h1>
	
<%	sql = "select about,skills from "+compName+" where name=?";
	ps = cn.prepareStatement(sql);
	ps.setString(1, "Selected");
	rs = ps.executeQuery();
	String remarks="",student_rollno="",score="",total_rating="";
	int n=0;
	while(rs.next())
	{
		n++;
...
function recruit(obj) {
	window.location.href='CompanySelectedStudents';
	return false;
}
</script>
</body>
